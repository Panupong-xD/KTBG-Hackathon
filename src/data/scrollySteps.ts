...
export const SCROLLY_STEPS: ScrollyStep[] = [
  ...
  },
  {
    ...
    description: "หากวันไหนผู้ใช้ใช้เงินน้อยกว่ายอดแนะนำ ระบบจะตรวจพบเงินเหลือจริงสิ้นวัน (Safe-to-Sweep) โดยหักสำรองหนี้สินและบิลล่วงหน้า 100% แล้วยื่นข้อเสนอแนะที่กระทบวิถีชีวิตน้อยที่สุด เช่น 'วันนี้มีเงินเหลือ ฿150 สนใจย้ายไปกระเป๋าเป้าหมายไหม' พร้อมคำแนะนำแนะนำปรับพฤติกรรมที่กระทบชีวิตน้อยที่สุด (LDI)",
    details: [
