...
export const SCROLLY_STEPS: ScrollyStep[] = [
  ...
  },
  {
    ...
    metrics: [
      { label: "ยอดใช้ได้วันนี้", value: "฿380 / วัน", sublabel: "หากใช้ไม่เกินนี้ เงินพอแน่นอน" },
  ...
  },
  {
    ...
    description: "หากวันไหนผู้ใช้ใช้เงินน้อยกว่ายอดแนะนำ ระบบจะตรวจพบเงินเหลือจริงสิ้นวัน (Safe-to-Sweep) โดยหักสำรองหนี้สินและบิลล่วงหน้า 100% แล้วยื่นข้อเสนอแนะที่กระทบวิถีชีวิตน้อยที่สุด เช่น 'วันนี้มีเงินเหลือ ฿150 สนใจย้ายไปกระเป๋าเป้าหมายไหม' พร้อมคำแนะนำ LDI (Least-Disruptive Intervention - การปรับพฤติกรรมที่กระทบชีวิตน้อยที่สุด)",
    details: [
      ...
      "อัลกอริทึม LDI ชี้แนะการปรับพฤติกรรมเล็กๆ ที่เพิ่มความปลอดภัยได้สูงสุด เช่น ลด Delivery ฿80/วัน (ตัวอย่างจำลอง)"
    ],
    metrics: [
