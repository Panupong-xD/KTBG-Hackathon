...
export default function ProblemGrid() {
  const problems = [
    ...
    },
    {
      ...
      thaiTitle: 'คำแนะนำแบบหว่านแห ไม่รู้จะเริ่มตรงไหน',
      icon: HelpCircle,
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {problems.map((item) => {
            ...
            return (
              ...
              >
                <div>
                  {/* Top Row: Green Number & Icon */}
                  <div className="flex items-center justify-between mb-4">
                    <span className="font-mono text-3xl sm:text-4xl font-black text-[#00A950] group-hover:scale-105 transition-transform">
                      {item.id}
                    </span>
                    <div className="w-11 h-11 rounded-xl bg-emerald-50 text-[#00A950] border border-emerald-200/80 flex items-center justify-center">
