  ...
  const problems = [
    {
      ...
      description: 'First Jobber เพิ่งได้เงินเดือนก้อนแรก เห็นเงินในบัญชี 15,000 บาทแล้วคิดว่ารอด แต่ความจริงมีค่าเช่าหอพัก ค่าน้ำไฟ และบิลคงค้างรอตัดอีก 7,160 บาทในอีก 18 วันข้างหน้า (เหลือเงินกินใช้วันละไม่ถึง 400 บาท)',
